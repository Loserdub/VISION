        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="order-2 md:order-1 space-y-8">
             ...
             <div className="space-y-6 text-white/80 font-light leading-relaxed text-lg font-sans">
                <p>
                  In the quiet corners of East Lansing, Michigan, a digital revolution is being sequenced. Justin Ray is not just a producer; he is the founder and curator of <a href="https://reddit.com/r/hybridproduction" target="_blank" rel="noreferrer" className="text-white border-b border-white/30 hover:border-white transition-colors">r/hybridproduction</a>, a community dedicated to dismantling the boundaries between genres.
                </p>
                <p>
                  His philosophy is simple yet radical: <span className="text-purple-300">sound is texture</span>. By treating audio like oil paint on a canvas—smearing, layering, and distorting—he creates hybrid soundscapes that defy classification. Whether it's the raw grit of <em>loserdub</em> or the cinematic expanse of <em>VISION</em>, Justin's work explores the beautiful friction between digital precision and organic chaos.
                </p>
             </div>
