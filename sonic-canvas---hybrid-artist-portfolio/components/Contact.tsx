...
import { Globe, Mail, Instagram, Send } from 'lucide-react';
...
const Contact: React.FC = () => {
  ...
  const handleSendTransmission = (e: React.FormEvent) => {
    ...
    const subject = `Transmission from ${name || 'Unknown'}`;
          ...
          <div className="space-y-10 flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <a href="#" className="p-4 rounded-none border border-white/10 hover:border-white hover:bg-white hover:text-black transition-all duration-300 group">
                  <Globe size={20} />
                </a>
                <a href="#" className="p-4 rounded-none border border-white/10 hover:border-white hover:bg-white hover:text-black transition-all duration-300 group">
                  <Instagram size={20} />
                </a>
                <a href="mailto:jray517@gmail.com" className="p-4 rounded-none border border-white/10 hover:border-white hover:bg-white hover:text-black transition-all duration-300 group">
                  <Mail size={20} />
                </a>
              </div>
            </div>
